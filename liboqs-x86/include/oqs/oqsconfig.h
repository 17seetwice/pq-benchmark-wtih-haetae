...
#define OQS_COMPILE_BUILD_TARGET "x86_64-Linux-6.2.0-33-generic"
...
#define OQS_ENABLE_KEM_SMAUG 1
#define OQS_ENABLE_KEM_smaug_1 1
#define OQS_ENABLE_KEM_smaug_3 1
#define OQS_ENABLE_KEM_smaug_5 1

#define OQS_ENABLE_KEM_NTRUPLUS 1
#define OQS_ENABLE_KEM_ntruplus_kem576 1
#define OQS_ENABLE_KEM_ntruplus_kem768 1
#define OQS_ENABLE_KEM_ntruplus_kem864 1
#define OQS_ENABLE_KEM_ntruplus_kem1152 1
...
#define OQS_ENABLE_SIG_haetae_2 1
#define OQS_ENABLE_SIG_haetae_3 1
#define OQS_ENABLE_SIG_haetae_5 1
